...
Hello coders! this year, we are proud to open-source our hackathon project. We welcome everyone to join our quest and contribute in this project.
...
You can get your own fork/copy of this project [formulahack](https://github.com/pplg-opensource/formulahack) by using the <kbd><b>Fork</b></kbd></a> button or clicking [this](https://github.com/pplg-opensource/formulahack).


### 4. Ready, Steady, Go... :

Once you have completed these steps, you are ready to start contributing
by checking our [issues tab](https://github.com/pplg-opensource/formulahack/issues) and creating [pull requests](https://github.com/pplg-opensource/formulahack/pulls).
...
https://github.com/pplg-opensource/formulahack.git
...
To create your branch, from your terminal window, change your directory so that you are working in the directory of the repository. Be sure to use the actual name of the repository (i.e. formulahack) to change into that directory.
...
```
git remote add upstream https://github.com/pplg-opensource/formulahack.git
```
